...
class HiddenLayer:
    ...
    def __init__(self,
        ...
        self.comp_cost = HiddenLayer._cross_entropy_cost(l, self.W_prob,
                                                         self.b_prob,
                                                         self.X, self.P)
        ...
        self.embed_cost = HiddenLayer._composition_cost(l, self.W_l,
                                                        self.b_l, self.X)
    ...
    def composite_train_functions(self):
        """ Composite training function upto layer l.
            Returns composition function and embedding function.
        """
